    ...
    public class UsersAdminController : Controller
    {
            ...
            params string[] selectedGroups)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    string fileName = Path.GetFileNameWithoutExtension(userViewModel.file.FileName);
                    string extension = Path.GetExtension(userViewModel.file.FileName);
                    fileName = "User" + userViewModel.Email+ userViewModel.username+ extension;
                    fileName = fileName.Replace(" ", "-");

                    path = fileName;

                    string savePath = Server.MapPath("~/AppFiles/");
                    userViewModel.file.SaveAs(Path.Combine(savePath, fileName));
                    userViewModel.image = path;
                ...
                { 
                    ...
                    //upload image in server in email name
