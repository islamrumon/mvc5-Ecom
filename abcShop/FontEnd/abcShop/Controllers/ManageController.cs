...
namespace abcShop.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            //get costomer id
            var or = db.customer_tbl.SingleOrDefault(a => a.aspnetuserid == id);
            //get all order
            var o = db.order_tbl.Where(a => a.customer_id == or.customer_id).ToList();
        ...
        public ActionResult LinkLogin(string provider)
        {
            ...
            return new mamberController.ChallengeResult(provider, Url.Action("LinkLoginCallback", "Manage"), User.Identity.GetUserId());
        }
